...
namespace HumberBankApplication_Group9
{
    public partial class MainBank : Form
    {
        ...
        private void stopPaymentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Employees.Request.StopPayment obj = new Employees.Request.StopPayment();
            obj.MdiParent = this;
            obj.Show();
        }
        ...
        private void transactionLimitToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Employees.Request.TransactionLimit obj = new Employees.Request.TransactionLimit();
            obj.MdiParent = this;
            obj.Show();
        }
        ...
        private void checkPendingTransfersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Employees.Transfer.PendingTransactions obj = new Employees.Transfer.PendingTransactions();
            obj.MdiParent = this;
            obj.Show();
        }
    }
